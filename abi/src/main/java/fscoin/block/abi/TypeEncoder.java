...
import fscoin.block.abi.datatypes.primitive.PrimitiveType;
import fscoin.block.utils.Numeric;

import static fscoin.block.abi.datatypes.Type.MAX_BIT_LENGTH;
import static fscoin.block.abi.datatypes.Type.MAX_BYTE_LENGTH;
