...
public abstract class TypeReference<T extends fscoin.block.abi.datatypes.Type>
    ...
    public static <T extends fscoin.block.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends fscoin.block.abi.datatypes.Type> TypeReference<T> create(
    ...
    protected static Class<? extends fscoin.block.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends fscoin.block.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends fscoin.block.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends fscoin.block.abi.datatypes.Type> baseClass =
        ...
        final int len = solidityType.length();
            ...
            if (arraySize == null || arraySize.equals("")) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "fscoin.block.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
